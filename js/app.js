...
const App = {
    ...
    projectData: [
        ...
        { title: 'Synkaro', desc: 'Real-time synchronized media sharing platform with WebRTC calls, watch-together rooms, and persistent chat.', tags: ['MERN', 'JS'], icon: 'ri-team-line', image: 'assets/images/Synkaro.png', imageClass: 'project-cover-image project-cover-image-panorama', imageBoxClass: 'project-image-box project-image-box-panorama', imageBg: '#000000', github: 'https://github.com/bhupeshchauhanz/Synkaro', live: 'https://synkaro.bhupeshchauhan.in', status: 'In Progress' },
        ...
        { title: 'ChauhanQuant', desc: 'Quantitative trading engine with algorithmic strategies, backtesting, and real-time financial data analytics.', tags: ['AI', 'JS'], icon: 'ri-stock-line', image: 'assets/images/Chauhan Quant.png', imageClass: 'project-cover-image project-cover-image-panorama', imageBoxClass: 'project-image-box project-image-box-panorama', imageBg: '#000000', github: null, githubConfidential: true, live: 'https://chauhanquant.tech', status: 'Private' }
    ],
